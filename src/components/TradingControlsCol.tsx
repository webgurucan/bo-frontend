...
const TradingControlsCol = ({ symbol, tradeType, enabledWorkspaces = {}, isLoggedIn }: Partial<Props>) => {
  return (
    <div className="trading-main-vertical-grid">
      <div className="trading-main-layout__paddingwrapper">
        ...
        {enabledWorkspaces[WorkspaceSettingEnum.BALANCE] && isLoggedIn && <div className="trading-main-layout__item">
