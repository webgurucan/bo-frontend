...
export const assetColumns = [{
  ...
  renderCell: function ({ cellData }) {
    ...
    return <div className="cpn-virtualized-table__cellwrapper text-left">{pair}</div>
  }
}, {
  dataKey: 'lastPrice',
  //@TODO i18n
  ...
  renderCell: function ({ rowData, cellData }) {
    ...
    return (<div className="cpn-virtualized-table__cellwrapper text-right">
    ...
    return (
      <div className="cpn-virtualized-table__cellwrapper text-center pl-5 pr-5">
        ...
        <Sparklines data={[5, 10, 5, 8, 5, 3, 6, 5, 10, 5, 8, 5, 3, 6]}>
          <SparklinesLine color="#23d886" style={{ fill: "none", strokeWidth: 2 }}  />
        </Sparklines>
      </div>
    )
  }
