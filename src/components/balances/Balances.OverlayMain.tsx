...
class BalancesOverlayMain extends React.PureComponent<Partial<BalancesOverlayMainProps>> {
	static defaultProps = {
	...
	render() {
		...
		return (
			<div id="balances-overlays">
				<span onClick={closeBalOverlay} className="closer clickable">×</span>
