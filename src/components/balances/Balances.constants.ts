...
export const DEFAULT_AMOUNT_WIDTH = (TOTAL_WIDTH - DEFAULT_TICKER_WIDTH) / 3 + MARGIN_LEFT;
...
export const BALANCES_TABLE_HEIGHT = BALANCES_TABLE_COMBINED_ROW_HEIGHT * NUMBER_OF_SHOWING_ROWS;
