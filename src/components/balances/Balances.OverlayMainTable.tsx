...
class BalancesOverlayMainTable extends React.PureComponent<Partial<BalancesOverlayMainTableProps>, Partial<BalancesOverlayMainTableState>> {
	static defaultProps = {
		ccy: '',
		balances: {},
		ticker: {},
			...
			<table className="compact highlight">
				<tbody>
					<tr>
						...
						<td className="col-num overlay-total">{hideBalances ? '*****' : <NumberFormat number={total} decimals={decimals} />}</td>
					...
					<tr>
						...
						<td className="col-num overlay-total">{hideBalances ? '*****' : <NumberFormat number={available} decimals={decimals} />}</td>
						<td className="col-info">
							<span className="show-soft show-smaller overlay-ccy">{ccy}</span>
						</td>
						<td className="col-info overlay-copy-total">
					...
					{(!isFiat(ccy) || rate > 0) ? (
						<tr className="overlay-equiv-row">
							...
							<td className="border-top col-num overlay-total-equiv">{hideBalances ? '*****' : <NumberFormat number={usdEquiv} decimals={decimals} />}</td>
