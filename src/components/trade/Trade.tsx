...
import { TABLE_PRESCAN_ROWS, TABLE_ROW_HEIGHT } from '@/constants/app.constants';
...
export const TradeList = ({ symbol, data = EMPTY_ARRAY, height = 361, loading, initTrades }: Partial<TradeHistoryProps>) => {
