...
const ContractRow = ({title, data}) => <div className="d-flex d-align-items-center d-justify-content-space-between">
    ...
    return(
      <Collapsible title="Contract Detail">
        <div className="contract-detail__wrapper">
          <ContractRow title="Instrument" data={<span className="text--blue">BTC/USD</span>}/>
