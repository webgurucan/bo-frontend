...
// data format: `orderId`
const CancelOrderBtn = ({ symbol, order, tooltip = 'Cancel order', onClick }: CancelOrderProps) => {
  ...
  const popupProps = {
    onAccept: onBtnClick,
    title: '',
    children: () => <p className="text-center">Are you sure you want to cancel that order?</p>,
    initWidth: 270
  }
  return (
