...
export const MarketBalance = () => {
  ...
  return isOpen ? (
    <div className="d-flex d-align-items-center cpn-market-info__balances clickable" onClick={() => setOpen(false)}>
      ...
      <div className="market-info__balances clickable" onClick={() => setOpen(true)}>
