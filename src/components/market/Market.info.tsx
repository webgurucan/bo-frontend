    ...
    <div className="d-flex d-align-items-center">
      <div className="cpn-market-info__short-info">
        <div className="cell">
          ...
          <div className="col">
            <div className="value"><NumberFormat number={high} decimals={decimals} /></div>
            <div className="value"><NumberFormat number={low} decimals={decimals} /></div>
          </div>
        </div>
      </div>
      <div className="cpn-market-info__short-info">
        <div className="cell">
          ...
          <div className="col">
            <div className="value"><NumberFormat prefix={sigma} number={dailyChangePerc} decimals={2} suffix="%" classes={dailyChangeClasses} /></div>
            <div className="value"><NumberFormat number={volume} decimals={amountDecimals} /></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="d-flex d-align-items-center">
      <div className="cpn-market-info__short-info">
        <div className="cell">
          ...
          <div className="col">
            <div className="value"><NumberFormat number={high} decimals={priceDecimals} /></div>
            <div className="value"><NumberFormat number={low} decimals={priceDecimals} /></div>
          </div>
        </div>
      </div>
      <div className="cpn-market-info__short-info">
        <div className="cell">
          ...
          <div className="col">
            <div className="value"><NumberFormat number={markPrice} decimals={2} /></div>
            <div className="value"><NumberFormat number={indexPrice} decimals={2} /></div>
          </div>
        </div>
      </div>
      <div className="cpn-market-info__short-info">
        <div className="cell">
          ...
          <div className="col">
            <div className="value"><NumberFormat number={dailyChangePerc} decimals={2} suffix="%" classes={dailyChangeClasses} /></div>
            <div className="value"><NumberFormat number={interestRate} decimals={5} /></div>
          </div>
        </div>
      </div>
      <div className="cpn-market-info__short-info">
        <div className="cell">
          ...
          <div className="col">
            <div className="value"><NumberFormat number={fundingRate} decimals={4} suffix="%" classes={fundingRateClasses} /></div>
            <div className="value"><NumberFormat number={volume} decimals={amountDecimals} /></div>
          </div>
        </div>
      </div>
