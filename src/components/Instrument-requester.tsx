...
class InstrumentRequester extends React.Component<Partial<InstrumentProps>> {
  ...
  render() {
    ...
    console.log('isInstrumentLoaded', isInstrumentLoaded, this.props.isSocketReady);
    return (
      isInstrumentLoaded ? this.props.children : <p>Loading instrument.....</p>
    );
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(InstrumentRequester)