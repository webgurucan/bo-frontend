...
export function renderRow({
  ...
  return <div
    ...
    style={style}
    key={key}
  >{t !== 'groupLabel' ? renderWatchListRow({
    columns: columns,
    rowHeight: rowHeight,
...
function renderGroupLabelRow({
  colPadding,
  rowData,
}) {
  return <div className={`pl-${colPadding}`}><span className="text--gray-100 font-bold font-size-10">{rowData.label}</span></div>
}
