...
export const getWatchListColumns = ({ 
  ...
  let columns = [{
    ...
    renderCell: function ({ rowData }) {
      ...
      return <LastTick symbol={rowData.ccy} price={data} showNumber={false}/>
    }
  }, {
    dataKey: 'ccy',
    //@TODO i18n
    ...
    renderCell: function ({ cellData }) {
      ...
      return <div className="cpn-virtualized-table__cellwrapper text-left font-bold show-soft clickable">{pair}</div>
    }
  }, {
    //@TODO i18n
    ...
    renderCell: function ({ rowData, wrap, cellData }) {
      if(showVolume) {
        ...
        const changed = cellData > 0 ? `+${slicedPercent}` : `${slicedPercent}`;
  
        return (<div className="cpn-virtualized-table__cellwrapper text-right font-semi-bold clickable">
  ...
  if(displayExtraColumn) {
    return [
      ...
      },
      {
        ...
        disableSort: true,
        renderCell: function ({ rowData }) {
          return <div className="cpn-virtualized-table__cellwrapper text-center font-semi-bold clickable">
