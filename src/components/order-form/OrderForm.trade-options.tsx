...
export class OrderFormTradeOptions extends React.PureComponent<OrderFormTradeOptionsProps> {
  ...
  renderCheckboxes(Checkbox) {
    ...
    return (
      <>
        {orderType !== OrderType.SNIPER_LIMIT && orderType !== OrderType.SNIPER_MKT ? <Checkbox value={TradeOption.POO} label="Post" /> : null}
  ...
  render() {
    ...
    return (
      <CheckboxGroup name="tradeOptions" value={selectedOptions} onChange={this.onCheckboxChange}>
