...
import { ICELayers, LastTradePriceType, MarginType, OrderSide, OrderType, StopTrigger, TIF, TradeOption } from "@/constants/order-enums";
...
export interface OrderFormContainerProps {
  ...
  submitOrderFn: (data: SubmitOrderEntryData, props: OrderFormContainerProps, state?: OrderFormControlsState, extraData?: AdditionPopupData) => void,
...
export interface OrderFormControlsProps {
  onClickHandler: (data: OrderEntryInfo, onError: () => void, state: OrderFormControlsState, extraData: AdditionPopupData) => void,
  side?: OrderSide,
  initialPrice: number,
  balances: object,
  isAuthenticated: boolean,
...
export type OrderFormInputDataFlows = OrderFormControlsState & {
  ...
  onOrderBtnClick: (clientId: number, data: AdditionPopupData, cb?: () => void) => void,
  onTotalChange: (total: number) => void,
  onUpdateAmountByBalancePercent: (balance: number, percent: number, side: any) => void,
  ...
  onTakeProfitLastTradePriceTypeChange: (lastTradePriceType: LastTradePriceType) => void,
  onStopLossLastTradePriceTypeChange: (lastTradePriceType: LastTradePriceType) => void,
...
export type OrderFormProps = OrderFormControlsState & OrderFormInputDataFlows & {
  mmr: number,
  balances: object,
  maxLeverage: number,
  wallet: WalletType,
