...
export const InstrumentRequestManner = new PacketManner(
  PacketHeaderMessageType.INSTRUMENT_REQUEST,
  INSTRUMENT_REQUEST_STRUCTURE
);
...
export const InstrumentManner = new PacketManner<InstrumentStructure>(
  PacketHeaderMessageType.INSTRUMENT,
