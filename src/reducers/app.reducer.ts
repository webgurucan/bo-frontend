import { CLOSE_ALL_MODALS, CLOSE_MODAL, OPEN_MODAL, UPDATE_WS_ENTRY } from "@/actions/app.actions";
  ...
  switch (action.type) {
    ...
    case OPEN_MODAL: {
      ...
      if (!~index) {
        ...
        if (component !== modals[index].component || !shallowCompareObjects(props, modals[index].modalProps)) {
          modals[index] = modal;
          return {
            ...state,
            modals
