...
export const InputRadioInline = ({radioClasses, label, checked, value, onChange}: Partial<InputRadioProps>) => {
  ...
  return (
    <label className={radioCls}>
      <div className="radio-container">
        <input type="radio" checked={checked} value={value} onChange={handleOnChange} />
...
export const InputCheckboxInline = ({radioClasses, name, label, checked, value, onChange}: Partial<InputCheckboxProps>) => {
  const handleOnChange = useCallback((e) => {
    e.stopPropagation();
    onChange(value, e);
  }, [onChange, value]);
  ...
  return (
    <label className={radioCls}>
      <div className="checkbox-container">
        <input type="checkbox" checked={checked} name={name} value={value} onChange={handleOnChange} />
        <span className={markCls}></span>
      </div>
      {label}
    </label>
