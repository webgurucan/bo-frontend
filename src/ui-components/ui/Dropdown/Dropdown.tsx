...
export const Dropdown = ({
  ...
  const contentClsses = classNames('cpn-dropdown__content', 'nodisplay', contentClasses, {
    'cpn-dropdown__content--top-right': position === DropdownPosition.TOP_RIGHT,
