...
export const NumberFormat = React.memo(({ number, decimals = 0, classes, suffix, prefix }: NumberAndDecimals) => (<span className={classes}>
  {prefix}{formatNumber({ number, decimals })}{suffix}
</span>));
...
export const NumberDiff = React.memo(({ 
  ...
  return <NumberFormat number={number} decimals={decimals} classes={cls} suffix={suffix}/>
});