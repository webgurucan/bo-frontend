...
import { closeWs, establishWsConn, sendSubscribe, sendUnsubscribe, sendWsData } from '@/actions/ws.actions';
  ...
  return (
    <div className="App">
      ...
      <button onClick={() => {
        ...
        console.log('instrument request reader:', InstrumentRequestManner.read(subSender));
        dispatch(sendWsData(2, subSender));
        
      }}>test request instrument</button>
      <br/>
      {/* <button onClick={() => {
        const params = {
